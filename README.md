...
| <a name="input_required_linear_history"></a> [required\_linear\_history](#input\_required\_linear\_history) | If it needs to use the linear history feature | `bool` | `false` | no |
